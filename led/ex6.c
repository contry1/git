/***************************************************************************
Copyright (C) Cambridge Silicon Radio Ltd. 2006-2013

	This file was auto-generated by the ledparse application from 
	BlueLab 6.3.1.0 and provides simple LED indications.
*****************************************************************************/
...
static const int gLedPinsUsed = 0xE000 ; 

/*BLUE_GREEN_RED_ALT*/
static const ledEntry_t pattern_BLUE_GREEN_RED_ALT [ 6 ] = 
{
    { 0x4000 , ON  , 1000 }  , 
    { 0x4000 , OFF , 0    }  , 
    { 0x8000 , ON  , 1000 }  , 
...
#define LED_NUM_PATTERNS ( 1 )

/*The LED entries*/
static const led_t gLeds [ LED_NUM_PATTERNS ] = 
{
    {  { 6,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_GREEN_RED_ALT } 
};
